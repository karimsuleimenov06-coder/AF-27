...
export const PACKS: PackTier[] = [
  {
    ...
    odds: { bronze: 0.88, silver: 0.11, gold: 0.009, special: 0.001, icon: 0, promo: 0 },
  ...
  },
  {
    ...
    odds: { bronze: 0.4, silver: 0.45, gold: 0.13, special: 0.02, icon: 0, promo: 0 },
  ...
  },
  {
    ...
    odds: { bronze: 0.08, silver: 0.32, gold: 0.5, special: 0.076, icon: 0.024, promo: 0 },
  ...
  },
  {
    ...
    odds: { bronze: 0, silver: 0.12, gold: 0.53, special: 0.326, icon: 0.024, promo: 0 },
