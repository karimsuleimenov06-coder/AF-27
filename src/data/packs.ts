...
export const PACKS: PackTier[] = [
  {
    ...
    odds: { bronze: 0.88, silver: 0.11, gold: 0.009, special: 0.001 },
  ...
  },
  {
    ...
    odds: { bronze: 0.4, silver: 0.45, gold: 0.13, special: 0.02 },
  ...
  },
  {
    ...
    description: 'Гарантированная золотая карточка и шанс на Astra',
    cardCount: 5,
    cost: { currency: 'gems', amount: 50 },
    odds: { bronze: 0.08, silver: 0.32, gold: 0.5, special: 0.1 },
  ...
  },
  {
    id: 'event',
    name: 'Astra Event',
    description: 'Лимитированный пак с гарантированной Astra-карточкой',
    cardCount: 5,
    cost: { currency: 'gems', amount: 140 },
    odds: { bronze: 0, silver: 0.12, gold: 0.53, special: 0.35 },
